...
public class BancoController {
    ...
    public String insereDado(String titulo, String autor, String editora){
        ...
        System.out.println("Dentro de valores: " + CriaBanco.TITULO);
        System.out.println("Dentro de valores: " + CriaBanco.AUTOR);
        System.out.println("Dentro de valores: " + CriaBanco.EDITORA);
